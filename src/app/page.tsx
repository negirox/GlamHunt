...
export default async function Home() {
  ...
  return (
    <>
      <section className="relative h-[60vh] min-h-[400px] flex items-center justify-center text-center bg-cover bg-center" style={{backgroundImage: "url('https://placehold.co/1920x1080.png')"}} data-ai-hint="fashion runway">
        <div className="absolute inset-0 bg-gradient-to-t from-background/80 via-background/20 to-transparent"></div>
        <div className="relative z-10 container mx-auto px-4 text-white">
          <h1 className="text-5xl md:text-7xl font-headline font-bold text-white drop-shadow-lg">GlamHunt</h1>
          <p className="text-lg md:text-xl text-white/90 mt-4 drop-shadow-md">Find Your Next Star. Discover and book top talent.</p>
          <div className="bg-background/80 backdrop-blur-sm p-4 sm:p-6 rounded-lg shadow-lg mt-8 max-w-4xl mx-auto">
